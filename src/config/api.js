...
export const API_CONFIG = {
  BASE_URL: isDevelopment ? 'http://localhost:5000' : 'https://celadonbuffalo.onpella.app',
  API_BASE_URL: isDevelopment ? 'http://localhost:5000/api' : 'https://celadonbuffalo.onpella.app/api',
