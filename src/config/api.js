...
export const API_CONFIG = {
  BASE_URL: isDevelopment ? 'http://localhost:5000' : 'https://viridianowl.onpella.app',
  API_BASE_URL: isDevelopment ? 'http://localhost:5000/api' : 'https://viridianowl.onpella.app/api',
